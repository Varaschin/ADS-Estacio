...
// Imprimindo dados da Carta 2:
        ...
        printf("Populacao: Venceu Carta 1 %d\n", populacao > populacao2);
        printf("População: Venceu Carta 2 %d\n", populacao < populacao2);
        printf("Area: Venceu Carta 1 %d\n", area > area2);
        printf("Area: Venceu Carta 2 %d\n", area < area2);
        printf("PIB: Venceu Carta 1 %d\n", pib > pib2);
        printf("PIB: Venceu Carta 2 %d\n", pib < pib2);
        printf("Pontos Turisticos: Venceu Carta 1 %d\n", pontos_turisticos > pontos_turisticos2);
        printf("Pontos Turisticos: Venceu Carta 2 %d\n", pontos_turisticos < pontos_turisticos2);
        printf("Densidade Populacional: Venceu Carta 1 %d\n", densidade_populacional < densidade_populacional2);
        printf("Densidade Populacional: Venceu Carta 2 %d\n", densidade_populacional > densidade_populacional2);
        printf("PIB per Capita: Venceu Carta 1 %d\n", pib_percapita > pib_percapita2);
        printf("PIB per Capita: Venceu Carta 2 %d\n", pib_percapita < pib_percapita2);
        printf("Super Poder: Venceu Carta 1 %d\n", super_poder > super_poder2);
        printf("Super Poder: Venceu Carta 2 %d\n", super_poder < super_poder2);
